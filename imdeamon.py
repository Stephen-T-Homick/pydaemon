...
parser = argparse.ArgumentParser(description = 'This is a light weight daemon to demonstrate a syslog server over UDP which inherits from a syslog client.')
parser.add_argument('--daemonize', help='Runs this in background as a "true" daemon - uninterruptible', required = False)
parser.add_argument('-help', action='help', help="Show this help message")
parser.add_argument('--port', help='Port of which to listen on. Default will be 33884', required = True)
